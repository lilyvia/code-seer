...
OpenCode 安全审计技能，基于 AST-grep 规则库进行自动化安全漏洞检测与分析，当前提供 72 条规则，支持 8 种编程语言（其中 JavaScript 规则承担 JavaScript/TypeScript 项目的 Wave 1 首轮扫描），覆盖 9 类常见漏洞类型。
