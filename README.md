...
OpenCode 安全审计技能，基于 AST-grep 规则库进行自动化安全漏洞检测与分析，支持 8 种编程语言（含 JavaScript/TypeScript），覆盖 9 类常见漏洞类型。
...
- **PHP** (`.php`) - PHP常见漏洞模式
- **C#** (`.cs`) - .NET平台安全检测
- **JavaScript/TypeScript** (`.js`/`.ts`) - 前端与Node.js安全检测
